...
export async function POST(request:Request){
 ...
 const before={proficiency:computeProficiency(priorEvents,owned.reviewWindowDays,now)};
 const after={proficiency:computeProficiency([...priorEvents,{isCorrect:data.isCorrect,createdAt:now,challengeType:data.challengeType}],owned.reviewWindowDays,now)};
